...
export const EVENTS = [
  {
    ...
    description: "Stage de Luta Livre avec Emilien Bouillart, ceinture noire 1er dan. Thématique : attaquer et défendre les jambes. Une excellente opportunité d'apprendre des techniques avancées de soumission et de défense au sol.",
  ...
  },
  {
    ...
    location: "Dojo SLAMM, 361 Rue de la Saudrais, 35800 Saint-Lunaire",
    price: "10€",
    description: "Stage de Luta Livre avec Emilien Bouillart, ceinture noire 2ème dan. Thématique : demi-garde. Une excellente opportunité d'améliorer son jeu au sol grâce à des techniques modernes, efficaces et actuelles.",
    performer: "Emilien Bouillart",
    maxParticipants: 30,
